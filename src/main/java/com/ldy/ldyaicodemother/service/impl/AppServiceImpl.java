package com.ldy.ldyaicodemother.service.impl;
...
import com.ldy.ldyaicodemother.core.handler.StreamHandlerExecutor;
...
import com.ldy.ldyaicodemother.model.enums.ChatHistoryMessageTypeEnum;
...
import com.ldy.ldyaicodemother.monitor.MonitorContext;
import com.ldy.ldyaicodemother.monitor.MonitorContextHolder;
import com.ldy.ldyaicodemother.service.ChatHistoryService;
import com.ldy.ldyaicodemother.service.ScreenshotService;
import com.ldy.ldyaicodemother.service.UserService;
import com.mybatisflex.core.query.QueryWrapper;
import com.mybatisflex.spring.service.impl.ServiceImpl;
import com.ldy.ldyaicodemother.model.entity.App;
import com.ldy.ldyaicodemother.mapper.AppMapper;
import com.ldy.ldyaicodemother.service.AppService;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App>  implements AppService{
    ...
    public Flux<String> chatToGenCode(Long appId, String message, User loginUser) {
        ...
        ThrowUtils.throwIf(ObjectUtil.isNull(app), ErrorCode.PARAMS_ERROR, "应用不存在");
        // 4. 获取应用的代码生成类型
        ...
        return streamHandlerExecutor.doExecute(contentFlux, chatHistoryService, appId,
                loginUser, codeGenTypeEnum);*/
        // 6. 设置监控上下文
